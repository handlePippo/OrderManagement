...
{
    public class ProvisionerApiAddressClientTests
    {
        ...
        private readonly ProvisionerApiAddressClient _sut;

        public ProvisionerApiAddressClientTests()
        {
            ...
            _sut = _fixture.Create<ProvisionerApiAddressClient>();
        }
        ...
        public async Task ListAsync_WhenSuccess_ReturnsList()
        {
            ...
            {
                req.Method.Should().Be(HttpMethod.Get);
                req.RequestUri!.ToString().Should().EndWith("api/addresses/list");
                return new HttpResponseMessage(HttpStatusCode.OK)
                {
        ...
        public async Task CreateAsync_WhenSuccess_SendsPostToExpectedUrlWithJsonBody()
        {
            ...
            _handler.LastRequest.RequestUri!.ToString().Should().EndWith("api/addresses");
        ...
        public async Task CreateAsync_WhenNonSuccess_ThrowsHttpRequestExceptionWithBody()
        {
            ...
            _handler.Responder = req =>
            {
                ...
                req.RequestUri!.ToString().Should().EndWith("api/addresses");
        ...
        public async Task UpdateAsync_WhenSuccess_SendsPutToExpectedUrlWithJsonBody()
        {
            ...
            _handler.LastRequest.RequestUri!.ToString().Should().EndWith($"api/addresses/{id}");
