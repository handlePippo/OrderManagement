...
{
    public sealed class ValidateUserAuthorizationFilterTests : IDisposable
    {
        private readonly Fixture _fixture = new();
        private readonly ValidateUserAuthorizationFilter _sut;
        private readonly ICurrentUserProvider _currentUserProvider = Substitute.For<ICurrentUserProvider>();
        private readonly IUserRepository _repository = Substitute.For<IUserRepository>();
        private readonly IMemoryCache _cache;

        public ValidateUserAuthorizationFilterTests()
        {
            ...
            _sut = _fixture.Create<ValidateUserAuthorizationFilter>();
        }
        ...
        public async Task OnActionExecutionAsync_WhenUserIsNotOwnerAndNotAdmin_ReturnsForbid()
        {
            ...
            var order = new User(ownerUserId);

            _repository.GetAsync(id, Arg.Any<CancellationToken>()).Returns(order);
        ...
        public async Task OnActionExecutionAsync_UsesCache_SecondCallDoesNotHitRepository()
        {
            ...
            _repository.GetAsync(id, default).Returns(order);
