...
namespace OrderManagement.Category.Api.Tests.Configuration.Middlewares
{
    public class GlobalExceptionHandlingMiddlewareTests
    {
        private readonly Fixture _fixture = new();
        private readonly GlobalExceptionHandlingMiddleware _sut;
        private readonly ILogger<GlobalExceptionHandlingMiddleware> _logger = Substitute.For<ILogger<GlobalExceptionHandlingMiddleware>>();
